...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (interaction.customId === `devmodal`) {
            ...
            const ticketcreated = new EmbedBuilder()
                .setTitle(`🔧 | Developer Sollicitatie`)
                .addFields(
                    { name: 'Gemaakt:', value: `${c}`, inline: true },
                    { name: 'Leeftijd:', value: `${age}`, inline: true },
                    { name: 'Waarom wil je een developer worden?', value: `${reason}`, inline: false },
                    { name: 'Wat zijn je sterke/zwakke punten?', value: `${sterk}`, inline: false },
                    { name: 'Wat wil je bereiken als developer?', value: `${bereiken}`, inline: false },

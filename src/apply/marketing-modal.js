...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (interaction.customId === 'apply-options') {
            if (interaction.values[0] === 'marketing-apply') {
                const user = interaction.member
                const userid = interaction.member.id
                const username = interaction.member.user.tag

                const modal = new ModalBuilder()
                .setCustomId(`marketingmodal`)
                ...
                const reason = new TextInputBuilder()
                    ...
                    .setLabel("Waarom wil je een marketing worden?")
                    .setRequired(true)
                ...
                const bereiken = new TextInputBuilder()
                    ...
                    .setLabel("Wat wil je bereiken als marketing?")
                    .setRequired(true)
                    .setStyle(TextInputStyle.Paragraph);

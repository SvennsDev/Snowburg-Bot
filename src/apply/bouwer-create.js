...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (interaction.customId === `bouwermodal`) {
            ...
            const ticketcreated = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Waarom wil je een bouwer worden?', value: `${reason}`, inline: false },
                    { name: 'Wat zijn je sterke/zwakke punten?', value: `${sterk}`, inline: false },
                    { name: 'Wat wil je bereiken als bouwer?', value: `${bereiken}`, inline: false },
                    { name: 'Voorbeelden van al gemaakt werk:', value: `${ervaring}`, inline: true },
                )
